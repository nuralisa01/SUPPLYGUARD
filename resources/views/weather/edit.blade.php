            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        @foreach($countries as $country)
                            ...
                            <option
                                value="{{ $country->id }}"
                                {{ old('country_id', $weather->country_id) == $country->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input
                        type="date"
                        name="weather_date"
                        value="{{ old('weather_date', $weather->weather_date) }}"
                        class="w-full border rounded-lg px-4 py-3">
                ...
                <div>
                    ...
                    <input
                        ...
                        step="0.01"
                        name="rainfall"
                        value="{{ old('rainfall', $weather->rainfall) }}"
                        class="w-full border rounded-lg px-4 py-3">
                ...
                <div>
                    ...
                    <input
                        type="number"
                        name="weather_code"
                        value="{{ old('weather_code', $weather->weather_code) }}"
                        class="w-full border rounded-lg px-4 py-3">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('weather_description', $weather->weather_description) }}"
                        class="w-full border rounded-lg px-4 py-3">
